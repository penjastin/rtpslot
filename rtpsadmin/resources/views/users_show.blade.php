        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" style="border-radius: 13px; box-shadow:1px 1px 5px 1px #CACACA">
                    <h4 class="card-header">{{ __('My profile') }}</h4>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-4"
                                    value="{{ $user->sites->site_name }}" disabled>
                            </div>
                            <div class="form-group">
                                <label class="">Member since</label>
                                <input type="text" class="form-control mb-4" value="{{ auth()->user()->created_at ? auth()->user()->created_at->format('d/m/Y') : 'N/A' }}" disabled>
                            </div>
                            <div class="form-group">
                                <label class="">Last login</label>
                                <input type="text" class="form-control mb-4" value="{{ auth()->user()->last_login ? auth()->user()->last_login->diffForHumans() : 'N/A' }}" disabled>
                            </div>
