    ...
    <section class="slot">
        <div id="wrapper" class="wrapper">
            <div class="text-center mt-4 box-logo">
                <a href="/">
                    <amp-img src="{{ $site_settings->logo_url }}" height="60px" width="170px" alt="Logo">
                    </amp-img>
                </a>
            </div>
            ...
            <amp-list layout="responsive" width="200px" height="66px" class="layout-list" src="/Vendor.json"
                ...
                <template type="amp-mustache">
                    <div class="app-footer">
                        <section class="app-footer__partners">
                            <div class="item2">
                                @{{ #items }}
                                <amp-img media="(max-width: 998px)" src="@{{ imageUrl }}" width="105"
                                    height="55" alt="@{{ vendor }}"></amp-img>
                                <amp-img media="(min-width: 998px)" src="@{{ imageUrl }}" width="130"
                                    height="60" alt="@{{ vendor }}"></amp-img>
                                @{{ /items }}
                                </a>
                            </div>
                        </section>
            ...
            <amp-state id="allGames" src="/prediksiByVendor.json"></amp-state>
            ...
            <amp-list width="auto" height="100" [height]="40 * filteredGames.length" layout="fixed-height"
                src="/prediksiByVendor.json" [src]="filteredGames" class="game-list" binding="no">
                <template type="amp-mustache">
                        ...
                        <div class="card-content">
                            ...
                            <a href="{{ $site_settings->site_url }}">
                                <amp-img class="img-zoom" src="@{{ image_url }}" alt="@{{ game_name }}"
                                    layout="responsive" width="200" height="150">
