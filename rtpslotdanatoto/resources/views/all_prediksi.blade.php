...
@section('content')
    <amp-list class="paged-amp-list" layout="fixed-height" height="800" src="/prediksiAll.json"
        [src]="'/prediksiAll.json?page=' + pageNumber" binding="no" reset-on-refresh single-item>
    ...
    <amp-state id="page" src="/prediksiAll.json" [src]="'/prediksiAll.json?page=' + pageNumber">
    </amp-state>
@endsection
